...
urlpatterns = [
    path('', views.inicio, name='bienvenido'),
    ...
    path('nueva_habilidad/', views.nueva_habilidad, name='nueva_habilidad'),
    path('nueva_educacion/', views.nueva_educacion, name='nueva_educacion'),
    path('nueva_experiencia/', views.nueva_experiencia, name='nueva_experiencia'),
]